...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/varunbhartia/development_projects/hellodjango/test.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'fi7o%65cj84gdvp#s904%#auu&2mz2h=w&_0io)h=lc52_q%jl'
